...
public class MouseLookkk : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 _movementVertical = transform.forward * _yMovement;
        ...
        //Calculate look up and look down camera rotation
    ...
    private void FixedUpdate()
    {
        ...
        if (fpsObject != null)
        {
            ...
            fpsObject.transform.localEulerAngles = new Vector3(CurrentCameraUpDownRotation, 0, 0);
        }
    }
